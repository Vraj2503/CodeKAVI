...
from rune.pipeline_models import FileEntry

try:
    from rune.config import EXTENSION_LANGUAGE_MAP, FILENAME_LANGUAGE_MAP
...
def load_fingerprints(repo_id: str) -> dict[str, FileFingerprint]:
    ...
    cache_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), ".rune-fingerprints")
