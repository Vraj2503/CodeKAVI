...
from rune.config import EMBEDDING_DIMENSION
...
COLLECTION_NAME = "codekavi_chunks"  # NOT renamed with the package: this addresses
# live Zilliz data. Renaming it orphans every embedding already paid for and
# forces a full re-index of every analyzed repo.
...
class ZillizClient:
    ...
    def setup_collection(self) -> Collection:
        ...
        if not self.connect():
            from rune.exceptions import VectorStoreError
