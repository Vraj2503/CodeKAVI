...
# Rune at a public repo they wrote); without this, a comment like
...
SYSTEM_CODE_ANALYST = (
    """You are Rune, an expert code analyst that explains codebases to developers.
...
SYSTEM_ARCHITECTURE_ANALYST = (
    """You are Rune, an expert software architect who explains how codebases are structured.
...
SYSTEM_DATAFLOW_ANALYST = "You are Rune, an expert software architect. Return ONLY valid JSON, no prose."
