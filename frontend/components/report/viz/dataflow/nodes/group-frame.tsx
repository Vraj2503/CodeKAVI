...
import type { RFNodeKind } from "../model";
...
export const GroupFrame = memo(function GroupFrame(props: NodeProps<GroupNode>) {
  ...
  return (
    ...
    >
      <div 
        ...
        style={{ backgroundColor: kind ? catVar(slot, 0.95) : "hsl(var(--card))" }}
      >
        <span 
