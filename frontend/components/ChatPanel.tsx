    ...
    <div className="flex-1 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        */}
                    ...
                    <div
                      className={cn(
                        msg.role === "assistant"
                          ...
                          : [
                              "max-w-[80%] break-words rounded-2xl rounded-br-md",
                              "border border-border bg-muted/70 px-4 py-2.5",
        ...
        {/* Composer */}
        <div className="flex-shrink-0 border-t border-border/60 bg-background/60 px-6 py-4">
          {/*
          ...
          */}
          <form
            ...
            className={cn(
              "flex items-end gap-2 rounded-xl border border-border bg-card p-2 pl-3.5",
      ...
      <div className="hidden w-64 flex-shrink-0 flex-col border-l border-border/60 bg-card/25 lg:flex">
