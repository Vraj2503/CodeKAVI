  ...
  return (
    <div className="w-full max-w-[22rem]">
      {authError && (
        <div
          role="alert"
          className="mb-4 rounded-lg border border-destructive/25 bg-destructive/10 px-3 py-2.5 text-center font-sans text-[13px] text-destructive"
        >
          {authError}
        </div>
      )}
      ...
      */}
      <button
        ...
        className={cn(
          "group flex w-full items-center justify-center gap-3 rounded-xl px-4 py-3.5",
          "border border-border bg-card font-sans text-[14.5px] font-medium text-foreground",
          "shadow-lift transition-[transform,border-color,background-color] duration-150 ease-out",
          "[@media(hover:hover)]:hover:border-foreground/25 [@media(hover:hover)]:hover:bg-accent/40",
