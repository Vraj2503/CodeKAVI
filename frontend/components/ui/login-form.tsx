...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-sm p-8 space-y-6 bg-card/40 backdrop-blur-xl rounded-2xl border border-border/40 shadow-2xl">
      ...
      {/* Error message */}
      {authError && (
        <div className="text-sm text-destructive text-center bg-destructive/10 py-2.5 px-3 rounded-lg border border-destructive/20">
          {authError}
        </div>
      )}
      ...
      <button
        ...
        className="w-full flex items-center justify-center py-3 px-4 bg-foreground/90 hover:bg-foreground rounded-xl text-background font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-primary transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
      >
        {isGoogleLoading ? (
      ...
      <p className="text-center text-xs text-muted-foreground leading-relaxed">
        ...
        <a href="#" className="text-primary hover:underline transition">Terms of Service</a>
        {" "}and{" "}
        <a href="#" className="text-primary hover:underline transition">Privacy Policy</a>
      </p>
    </div>
  );
}